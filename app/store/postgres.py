...
def insert_analytics_event(*, event_name: str, category: str | None, department: str | None, url: str | None,
                           session_id: str | None, user_id: str | None, source: str) -> None:
    with connect(settings.postgres_dsn) as con:
        con.execute(
            """INSERT INTO analytics_events(event_name, category, department, url, session_id, user_id, source)
               VALUES (%s,%s,%s,%s,%s,%s,%s)""",
